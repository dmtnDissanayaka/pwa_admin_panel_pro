                    ...
                    <form id="form_user">
                        ...
                        <div>
                            <div class="row fw-bold">
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Order No : {{$order_head_result->order_number}}</div>
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Truck No : {{$order_head_result->truck_number}}</div>
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Trailer : {{$order_head_result->trailer_number_1}} {{$order_head_result->trailer_number_2}} {{$order_head_result->trailer_number_3}}</div>
                                </div>
                                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                    @if(!empty($order_note_result->Dispatcher_Notes))
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Dispatcher Notes : {{$order_note_result->Dispatcher_Notes}}</div>
                                    @else
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Dispatcher Notes : Not provided</div>
                                    @endif

                                    @if(!empty($order_instrct_result->Driver_Instructions))
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Driver Instructions : {{$order_instrct_result->Driver_Instructions}}</div>
                                    @else
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content ">
                                                                    ...
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row mb-0">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Company : {{ $order_statu->Company_Name}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Address : {{ $order_statu->Address_Line_1}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Contact : {{ $order_statu->Contact_Person}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Phone/ext : {{ $order_statu->Phone_Number}} {{ $order_statu->Phone_Extension}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Load ID-1 : {{ $order_statu->Load_ID_Reference_1}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Load ID-2 : {{ $order_statu->Load_ID_Reference_2}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Commodity : {{ $order_statu->Commodity}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Hazardous : {{ $order_statu->Hazardous_Goods}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Tarping : {{ $order_statu->Tarping}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Plastic Wrap : {{ $order_statu->Plastic_Wrap}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Over dim : {{ $order_statu->Over_Dimensional}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Heat/Temp : {{ $order_statu->Heat_Required}} {{ $order_statu->Heat_Temperature}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    {{-- </div> --}}
                                                ...
                                                <div class="tab-pane" id="profile1" role="tabpanel">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            @foreach ($order_status_Delivery as $order_status_Delivery_data)
                                                                <div class="modal-header p-3 mt-2 bg-soft-dark">
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row mb-0">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Company : {{ $order_status_Delivery_data->Company_Name}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Address : {{ $order_status_Delivery_data->Address_Line_1}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Contact : {{ $order_status_Delivery_data->Contact_Person}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Phone/ext : {{ $order_status_Delivery_data->Phone_Number}} {{ $order_status_Delivery_data->Phone_Extension}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Load ID-1 : {{ $order_status_Delivery_data->Load_ID_Reference_1}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Load ID-2 : {{ $order_status_Delivery_data->Load_ID_Reference_2}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Commodity : {{ $order_status_Delivery_data->Commodity}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Hazardous : {{ $order_status_Delivery_data->Hazardous_Goods}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Tarping : {{ $order_status_Delivery_data->Tarping}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Plastic Wrap : {{ $order_status_Delivery_data->Plastic_Wrap}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Over dim : {{ $order_status_Delivery_data->Over_Dimensional}}</div>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Heat/Temp : {{ $order_status_Delivery_data->Heat_Required}} {{ $order_status_Delivery_data->Heat_Temperature}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    {{-- </div> --}}
                                                ...
                                                <div class="tab-pane " id="messages1" role="tabpanel">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                        @foreach ($order_status_borderx as $order_status_borderx_data)
                                                                <div class="modal-header p-3 mt-2 bg-soft-dark">
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Broker : {{ $order_status_borderx_data->Broker}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                    ...
                                                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Broker Ph : {{ $order_status_borderx_data->Phone_number}}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    {{-- </div> --}}
                                                ...
                                                <div class="tab-pane " id="settings" role="tabpanel">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                        @foreach ($order_status_changes as $order_status_change)
                                                                <div class="modal-header p-3 mt-2 bg-soft-dark">
                                                                    <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Status : <span style="text-transform: uppercase;"> {{ $order_status_change->status}}</span></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Date : <span style="text-transform: uppercase;">{{ $order_status_change->date}}</span></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Time : <span style="text-transform: uppercase;">{{ $order_status_change->time}}</span></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">Reason : <span style="text-transform: uppercase;">{{ $order_status_change->reason}}</span></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
