                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <p class="v-text-align v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 16px; ">
                                                                You are receiving this email because we receved a
                                                                password reset request from your account.
                                                            </p>
                                                                ...
                                                                <a href="{{ route('reset.password.get', $token) }}"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:10px 20px;line-height:120%;"><span
                                                                            style="line-height: 16.8px;">Reset Password
                                                                        </span></span>
                                                                </a>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;">This
                                                                    This
                                                                    email was sent by Event & Member Management System |
                                                                    Simplinology</p>
                                                            </div>
