...
<div class="container_loging">
    <div class="myform">
        <form action="<?php echo e(route('reset_password')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h3 class="text-center mb-4">Password Rest</h3>
...
unset($__errorArgs, $__bag); ?>" name="password"
                    placeholder="Enter confirm password" id="conpassword" >
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\CANADA-New\PWA_ADMIN_PANEL\resources\views/auth/new_password.blade.php ENDPATH**/ ?>