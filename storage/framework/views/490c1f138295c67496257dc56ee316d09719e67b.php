...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#orderFilter').keyup(function() {
            ...
            tblorderlist.ajax.url('<?php echo e(route('search_filter')); ?>?orderFilter=' + orderFilter).load();
        });
        $('#companyFilter').keyup(function() {
            var companyFilter = $('#companyFilter').val();
            tblorderlist.ajax.url('<?php echo e(route('company_filter')); ?>?companyFilter=' + companyFilter).load();
        });
        $('#driverFilter').keyup(function() {
            var driverFilter = $('#driverFilter').val();
            tblorderlist.ajax.url('<?php echo e(route('driver_filter')); ?>?driverFilter=' + driverFilter).load();
        });
        $('#typeFilter').change(function() {
            var typeFilter = $('#typeFilter').val();
            tblorderlist.ajax.url('<?php echo e(route('type_filter')); ?>?typeFilter=' + typeFilter).load();
        });
        $('#dateFilter').change(function() {
            var dateFilter = $('#dateFilter').val();
            console.log(dateFilter);
            tblorderlist.ajax.url('<?php echo e(route('date_filter')); ?>?dateFilter=' + dateFilter).load();
        });
        $('#readStatusFilter').change(function() {
            var readStatusFilter = $('#readStatusFilter').val();
            console.log(readStatusFilter);
            tblorderlist.ajax.url('<?php echo e(route('readStatus_Filter')); ?>?readStatusFilter=' + readStatusFilter).load();
        });
        $('#statusFilter').keyup(function() {
            var statusFilter = $('#statusFilter').val();
            console.log(statusFilter);
            tblorderlist.ajax.url('<?php echo e(route('status_Filter')); ?>?statusFilter=' + statusFilter).load();
        });
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\CANADA-New\PWA_ADMIN_PANEL\resources\views/order-list.blade.php ENDPATH**/ ?>