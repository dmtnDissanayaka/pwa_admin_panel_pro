            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        case ('ru'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/russia.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language"
                                >
                        <?php break; ?>
                        <?php case ('it'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/italy.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language"
                                >
                        <?php break; ?>
                        <?php case ('sp'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/spain.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language"
                                >
                        <?php break; ?>
                        <?php case ('ch'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/china.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language"
                                >
                        <?php break; ?>
                        <?php case ('fr'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/french.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language"
                                >
                        <?php break; ?>
                        <?php case ('gr'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/germany.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language"
                                >
                        <?php break; ?>
                        <?php default: ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/us.svg')); ?>" class="me-2 rounded" height="20" alt="Header Language" height="16">
                    <?php endswitch; ?>
                    </button>
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <span class="badge badge-soft-warning fs-13"><span class="cartitem-badge">7</span> items
                                    </span>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH F:\Virtual Systems\Laravel\Laravel\saas\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>