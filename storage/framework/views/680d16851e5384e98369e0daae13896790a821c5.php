                        ...
                        <div class="col-lg-4">
                            <div class="d-flex p-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted my-3">The collection of rules and guidelines which designers use
                                        to communicate with users through appealing.</p>
                                    <div>
                                        <a href="#" class="fs-13 fw-medium">Learn More <i
                                                class="ri-arrow-right-s-line align-bottom"></i></a>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex p-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted my-3">Business development firm that provides strategic planning,
                                        market research services and project.</p>
                                    <div>
                                        <a href="#" class="fs-13 fw-medium">Learn More <i
                                                class="ri-arrow-right-s-line align-bottom"></i></a>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex p-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted my-3">You usually get a broad range of options to play with. This
                                        enables you to use a single theme across multiple.</p>
                                    <div>
                                        <a href="#" class="fs-13 fw-medium">Learn More <i
                                                class="ri-arrow-right-s-line align-bottom"></i></a>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex p-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted my-3">Personalise your own website, no matter what theme and what
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex p-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted my-3">Responsive design is a graphic user interface (GUI) design
                                        approach used to create content.</p>
                                    <div>
                                        <a href="#" class="fs-13 fw-medium">Learn More <i
                                                class="ri-arrow-right-s-line align-bottom"></i></a>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex p-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted my-3">Google Fonts is a collection of 915 fonts, all available to
                                        use for free on your website.</p>
                                    <div>
                                        <a href="#" class="fs-13 fw-medium">Learn More <i
                                                class="ri-arrow-right-s-line align-bottom"></i></a>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="d-flex p-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="text-muted my-3">An industrial specialist works with industrial operations to
                                        ensure that manufacturing facilities work.</p>
                                    <div>
                                        <a href="#" class="fs-13 fw-medium">Learn More <i
                                                class="ri-arrow-right-s-line align-bottom"></i></a>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="text-muted">
                                ...
                                <p class="mb-4 fs-16">Collection widgets specialize in displaying many elements of the
                                    same type, such as a collection of pictures from a collection of articles from a news
                                    app or a collection of messages from a communication app.</p>
                            ...
                            <div class="accordion custom-accordionwithicon custom-accordion-border accordion-border-box"
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="genques-headingOne">
                                        <button class="accordion-button fw-semibold fs-14" type="button"
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="row justify-content-center">
                                                <div class="col-10">
                                                    <div class="text-white-50">
                                                        <p class="fs-20 mb-4">" Amazing template, Redux store and
                                                            components is nicely designed.
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Virtual Systems\Laravel\Laravel\saas\resources\views/landing.blade.php ENDPATH**/ ?>