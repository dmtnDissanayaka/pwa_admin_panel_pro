            ...
            <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <ul class="nav nav-sm flex-column">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="#sidebaremailTemplates" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebaremailTemplates" data-key="t-email-templates">
                                                <?php echo app('translator')->get('translation.email-templates'); ?> <span class="badge badge-pill bg-danger" data-key="t-new"><?php echo app('translator')->get('translation.new'); ?></span>
                                            </a>
                                            <div class="collapse menu-dropdown" id="sidebaremailTemplates">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <a href="apps-email-basic" class="nav-link" data-key="t-basic-action"> <?php echo app('translator')->get('translation.basic-action'); ?> </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="apps-email-ecommerce" class="nav-link" data-key="t-ecommerce-action"> <?php echo app('translator')->get('translation.ecommerce-action'); ?> </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarnft" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarnft" data-key="t-nft-marketplace">
                                    <?php echo app('translator')->get('translation.nft-marketplace'); ?> <span class="badge badge-pill bg-danger" data-key="t-new"><?php echo app('translator')->get('translation.new'); ?></span>
                                </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="bx bx-layout"></i> <span><?php echo app('translator')->get('translation.layouts'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLanding">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="landing" class="nav-link" data-key="t-one-page"> <?php echo app('translator')->get('translation.one-page'); ?> </a>
                            </li>
                            <li class="nav-item">
                                <a href="nft-landing" class="nav-link" data-key="t-nft-landing"> <?php echo app('translator')->get('translation.nft-landing'); ?> <span class="badge badge-pill bg-danger" data-key="t-new"><?php echo app('translator')->get('translation.new'); ?></span></a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUI">
                        <i class="bx bx-palette"></i> <span><?php echo app('translator')->get('translation.base-ui'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAdvanceUI">
                        <i class="bx bx-briefcase-alt"></i> <span><?php echo app('translator')->get('translation.advance-ui'); ?></span>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="widgets">
                        <i class="bx bx-aperture"></i> <span><?php echo app('translator')->get('translation.widgets'); ?></span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarForms">
                        <i class="bx bx-receipt"></i> <span><?php echo app('translator')->get('translation.forms'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTables" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTables">
                        <i class="bx bx-table"></i> <span><?php echo app('translator')->get('translation.tables'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCharts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCharts">
                        <i class="bx bx-doughnut-chart"></i> <span><?php echo app('translator')->get('translation.charts'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarIcons">
                        <i class="bx bx-tone"></i> <span><?php echo app('translator')->get('translation.icons'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMaps">
                        <i class="bx bx-map-alt"></i> <span><?php echo app('translator')->get('translation.maps'); ?></span>
                    </a>
...
<?php /**PATH F:\Virtual Systems\Laravel\Laravel\saas\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>
