...
<![endif]-->
    ...
    <!--<![endif]-->
    <title><?php echo e($staffEmailData['subject']); ?></title>
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://docv1.bimatrix.ca/_nuxt/temp_hls_image.Bx8beFk7.png" alt="image"
                                                                            title="image"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <strong> <?php echo e($staffEmailData['message']); ?></strong>
                                                            </h1>
                                        ...
                                        <div
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                Your confimation code is below enter it in your open browser window and we'll help you get signed in.
                                                            </h1>
                                            ...
                                            <table id="u_content_heading_4" style="font-family:'Raleway',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap: break-word; word-break: break-word; padding: 40px 60px 10px; font-family: 'Raleway', sans-serif;; vertical-align: middle;"
                                                            align="center">
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px;">
                                                                <?php echo e($staffEmailData['password']); ?>
...
<?php /**PATH F:\CANADA-New\PWA_ADMIN_PANEL\resources\views/emails/staff-created.blade.php ENDPATH**/ ?>