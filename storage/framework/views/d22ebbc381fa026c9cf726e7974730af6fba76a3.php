                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <p class="text-uppercase fw-medium fs-12 text-muted mb-1">Day
                                            Change</p>
                                        <h4 class=" mb-0">$<span class="counter-value"
                    ...
                    <div data-simplebar style="height: 390px;">
                        <div class="p-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="fs-13 mb-1">Bought Bitcoin</h6>
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="fs-13 mb-1">Sent Eathereum</h6>
                                    <p class="text-muted fs-12 mb-0">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="fs-13 mb-1">Sell Dash</h6>
                                    <p class="text-muted fs-12 mb-0">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="fs-13 mb-1">Sell Dogecoin</h6>
                                    <p class="text-muted fs-12 mb-0">
                                        <i class="mdi mdi-circle-medium text-success fs-15 align-middle"></i>
                                        www.coinmarket.com
                                    </p>
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="fs-13 mb-1">Bought Litecoin</h6>
                                    <p class="text-muted fs-12 mb-0">
                                        <i class="mdi mdi-circle-medium text-warning fs-15 align-middle"></i>
                                        Payment via Wallet
                                    </p>
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-13 mb-1">Bitcoin</h6>
                                <p class="text-muted mb-0">$18.7 Billions</p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                                <h6 class="fs-13 mb-1">$12,863.08</h6>
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-13 mb-1">Eathereum</h6>
                                <p class="text-muted mb-0">$27.4 Billions</p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                                <h6 class="fs-13 mb-1">$08,256.04</h6>
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-13 mb-1">Avalanche</h6>
                                <p class="text-muted mb-0">$12.9 Billions</p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                                <h6 class="fs-13 mb-1">$11,896.13</h6>
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-13 mb-1">Dogecoin</h6>
                                <p class="text-muted mb-0">$09.5 Billions</p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                                <h6 class="fs-13 mb-1">$15,999.06</h6>
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-13 mb-1">Binance</h6>
                                <p class="text-muted mb-0">$14.2 Billions</p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                                <h6 class="fs-13 mb-1">$13,786.18</h6>
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-13 mb-1">Litecoin</h6>
                                <p class="text-muted mb-0">$09.5 Billions</p>
                            </div>
                            <div class="flex-shrink-0 text-end">
                                <h6 class="fs-13 mb-1">$10,604.27</h6>
...
<?php echo $__env->make('layouts.layouts-vertical-hovered', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Virtual Systems\Laravel\Laravel\saas\resources\views/layouts-vertical-hovered.blade.php ENDPATH**/ ?>