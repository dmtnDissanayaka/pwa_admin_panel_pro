            ...
            function load_category1() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // cat1 = response.data
                        // $('#discountRevenueAccount').dxSelectBox("instance").option("dataSource", cat1);
                        // $('#discountRevenueAccountU').dxSelectBox("instance").option("dataSource", cat1);
                        // var data = cat1
                        //     .filter(function(el) {
                        //         return el.ID == cat1.ID
                        //     });
                        // $('#discountRevenueAccount').dxSelectBox("instance").option("value", data[0]);
                    }
                })
            };
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\CANADA-New\PWA_ADMIN_PANEL\resources\views/apps-tasks-list-view.blade.php ENDPATH**/ ?>